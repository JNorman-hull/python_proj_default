...
acc_max = (
    raw.groupby("file")["inacc_mag_ms"]
    .max()
    .reset_index()
    .rename(columns={"inacc_mag_ms": "max_acc_g"})
)
...
methods = {
    ...
    "Threshold_50ms":  df["pred_50g"].values,
    "Threshold_100ms": df["pred_100g"].values,
    "Threshold_150ms": df["pred_150g"].values,
}
...
method_labels = ["MiniRocket", "Threshold_150ms", "Threshold_100ms", "Threshold_50ms"]
# Colours: MiniRocket, 95g, 200g, 400g, Van Esch, Observed
METHOD_COLORS = {
    "MiniRocket":     "#2c7bb6",
    "Threshold_50ms":  "#d7191c",
    "Threshold_100ms": "#fdae61",
    "Threshold_150ms": "#1a9641",
    "Van Esch":       "#7b2d8b",
    "Observed":       "#636363",
}
